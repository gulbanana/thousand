...
namespace Thousand.Parse
{
    ...
    {
        public static TokenListParser<TokenKind, (T1?, T2?)> Shorthand<T1, T2>(TokenListParser<TokenKind, T1> p1, TokenListParser<TokenKind, T2> p2)
            where T1 : struct
            where T2 : struct
        ...
        public static TokenListParser<TokenKind, (T1?, T2?, T3?)> Shorthand<T1, T2, T3>(TokenListParser<TokenKind, T1> p1, TokenListParser<TokenKind, T2> p2, TokenListParser<TokenKind, T3> p3)
            where T1 : class
            where T2 : class
            where T3 : struct
        => (TokenList<TokenKind> input) =>
        ...
        public static TokenListParser<TokenKind, T> From<T>(Attributes.AttributeDefinition<T> definition)
        {
        ...
        public static TokenListParser<TokenKind, T> From<T>(IEnumerable<Attributes.AttributeDefinition<T>> definitions)
        {
