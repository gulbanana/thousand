...
namespace Thousand.Tests.Composition
{
    public class Endpoints : IDisposable
    {
        ...
        {
            var left = Object() with { Shape = ShapeKind.Rect, MinWidth = 20, MinHeight = 10 };
            var right = Object() with { Shape = ShapeKind.Rect, MinWidth = 20, MinHeight = 10, Row = 2, Column = 2 };
        ...
        {
            var left = Object() with { Shape = ShapeKind.Diamond, MinWidth = 50, MinHeight = 50 };
            var right = Object() with { Shape = ShapeKind.Rect, MinWidth = 150, MinHeight = 50, Row = 2, Column = 2 };
